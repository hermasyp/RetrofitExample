...
class MainListAdapter: RecyclerView.Adapter<MainItemListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainItemListViewHolder {
        return MainItemListViewHolder(
    ...
    override fun onBindViewHolder(holder: MainItemListViewHolder, position: Int) {
